...
function setMoviment ( id ) {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/MovimentSet.php", requestOptions )
        .then(
            () => {
...
function movimentGetById ( id ) {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/MovimentGetById.php", requestOptions )
        .then( res => res.json() )
        .then( data => {
...
function registerMoviment () {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/MovimentReg.php", requestOptions )
        .then( () => {
            if ( document.getElementById( 'categories1' ).value
                || document.getElementById( 'mes' ).value
                || document.getElementById( 'ano' ).value )
...
function deleteMoviment ( id ) {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/MovimentDel.php", requestOptions )
        .then(
            () => {
                if ( document.getElementById( 'categories1' ).value
                    || document.getElementById( 'mes' ).value
...
function getCategories ( tag ) {
    ...
    switch ( tag )
    {
        ...
        case 'span':
            ...
            break;
        case 'start':
            fetch( 'http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/CategoryGet.php', { method: 'get' } )
                .then( res => { return res.json(); } )
                .then( data => {
...
function registerCategory () {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/CategoryReg.php", requestOptions )
...
function deleteCategory ( id ) {
    ...
    fetch( "http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/CategoryDel.php", requestOptions )
        .then( getCategories( 'start' ) )
        .catch( error => console.log( 'error', error ) );
}
...
function getDate () {
    ...
    fetch( 'http://cloudcontapi-env.eba-bdc2ryha.sa-east-1.elasticbeanstalk.com/view/DateGet.php', { method: 'get' } )
        .then( res => { return res.json(); } )
        .then( data => {
